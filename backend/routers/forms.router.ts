...
formRouter.post('/forms', sanitizer, authenticateAndCsrf, formController.createForm);
formRouter.put('/forms/:id', sanitizer, authenticateAndCsrf, formController.updateForm);
formRouter.delete('/forms/:id', authenticateAndCsrf, formController.deleteForm);
formRouter.put('/forms/:id/publish', authenticateAndCsrf, formController.publishForm);
